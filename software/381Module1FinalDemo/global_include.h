...
#define INIT_BALL_XPOS_TO_LEFT    (int)SCREEN_WIDTH - PLAYER_2_WIDTH - CANNON_2_WIDTH;
...
#define PLAYER_ONE_Y1	SCREEN_HEIGHT - GROUND_HEIGHT
#define PLAYER_ONE_X2	PLAYER_WIDTH
#define PLAYER_ONE_Y2	SCREEN_HEIGHT-GROUND_HEIGHT - PLAYER_HEIGHT

#define PLAYER_TWO_X1	SCREEN_WIDTH-PLAYER_WIDTH
#define PLAYER_TWO_Y1	SCREEN_HEIGHT - GROUND_HEIGHT
#define PLAYER_TWO_X2	SCREEN_WIDTH
#define PLAYER_TWO_Y2	SCREEN_HEIGHT - GROUND_HEIGHT -PLAYER_HEIGHT
